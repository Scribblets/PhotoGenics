<div class="modal fade" id="printModal" tabindex="-1" role="dialog" aria-labelledby="printModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			{{ Form::open(array('url'=>'newprint','method'=>'POST', 'files'=>true)) }}
				...
				<div class="form-group print-info-group">
					...
					<div class="form-group">
						...
						<div class="form-group dimensions-group">
							...
							<input type="text" class="form-control" id="tf_dimensions" name="tf_dimension" data-mask='99" x 99"' placeholder='__" x __"'>
						</div>
					</div>
