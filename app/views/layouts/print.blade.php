<div class="modal fade" id="printModal" tabindex="-1" role="dialog" aria-labelledby="printModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="POST" enctype="multipart/form-data" id="printForm">
				<div class="modal-body">
					<div class="form-group print-info-group">
						<div class="form-group">
							<label for="tf_title" class="control-label">Title:</label>
							<input type="text" class="form-control" id="tf_title" name="tf_title" value="">
						</div>
						...
						<div class="form-group">
							...
							<div class="form-group price-group">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" id="tf_price" name="tf_price" value="">
								</div>
							</div>
							
							<div class="form-group dimensions-group">
								<label for="tf_dimensions">Dimensions:</label>
								<input type="text" class="form-control" id="tf_dimensions" name="tf_dimensions" value="" data-mask='99" x 99"' placeholder='__" x __"'>
							</div>
						</div>
